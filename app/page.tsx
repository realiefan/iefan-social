...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-900 text-white mx-auto">
      ...
      <div className="container mx-auto px-8 py-12 lg:px-16">
        ...
        <div className="inline-block">
          ...
          <div>Hey, iefan here!</div>
          <div className="text-sm text-gray-500 dark:text-gray-400">Experties: Cloud, Code & Security</div>
          </div>
        </section>

        <section className="bg-gradient-to-r  mt-5 rounded-lg mb-12">
            <h2 className="text-3xl font-bold mb-4 text-white">
              About Me
            </h2>
            <div className="bg-white dark:bg-gray-800 shadow rounded p-6">
               <p className="text-gray-800 font-medium text-base lg:text-lg dark:text-gray-300">
                Versatile Cloud Administrator with programming and Linux expertise,
                I specialize in managing cloud infrastructure, optimizing solutions, and automating
                tasks.
              </p>
            </div>
          </section>
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="container py-7 pt-0 mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={skill}
                className="flex items-center justify-center h-16 bg-white dark:bg-gray-800 rounded shadow text-gray-800 dark:text-gray-100">
                {skill}
              </div>
            ))}
          </div>
